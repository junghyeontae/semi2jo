...
<head>
    ...
    <link rel="stylesheet" href="../resources/css/manager/manageView.css">
...
<div class="total">
	...
	<div class="right">
		      ...
		      <table border="1" id = "change1" class="managerTable">
		          <!-- <form action="" method="POST"> -->
		              ...
		              <tr>
		                  ...
		                  <td><input type="file" id="" valu="사진 전송" onchange="ShowImage(this);"></td>
		              </tr>
		              <tr>
		  ...
		  <!-- 2. 회원 수정  -->
		      <table id = "change2" class="managerTable" border="1">
		          <form action="" method="POST">
		              ...
		              <tr>
		                  <td> 성 별 </td>
		                  <td> <input type="radio" value="남" name="gender1" checked disabled> 남 &nbsp; <input type="radio" value="여" name="gender1"> 여</text></td>
		              </tr>
		              <tr>
		                  <td> 부서 변경 </td>
		                  <td>
		              ...
		              <tr>
		                  ...
		                  <!-- 2. -->
		                  <td>
		                      <input type="file" id="aa" valu="사진 전송" onchange="fileShow(this);">
		                  </td>
		              </tr>
		              <tr>
		...
		<script src="../resources/js/manager/loginPage.js"></script>
	</div><!-- div.right -->
